...
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------------------------------------------------------------------------------------------
local SOURCELIB_URL = "https://raw.github.com/gbilbao/Bilbao/master/BoL1/Common/SourceLib.lua"
...
if AUTOUPDATE then
	SourceUpdater(SCRIPT_NAME, version, "raw.github.com", "/gbilbao/Bilbao/master/BoL1/"..SCRIPT_NAME..".lua", SCRIPT_PATH .. GetCurrentEnv().FILE_NAME, "/gbilbao/Bilbao/master/BoL1/"..SCRIPT_NAME..".version"):CheckUpdate()
end

local RequireI = Require("SourceLib")
	RequireI:Add("vPrediction", "https://raw.github.com/gbilbao/Bilbao/master/BoL1/Common/VPrediction.lua")
	RequireI:Add("SOW", "https://raw.github.com/gbilbao/Bilbao/master/BoL1/Common/SOW.lua")
	RequireI:Check()
